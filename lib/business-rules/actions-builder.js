(function($) {
  ...
  ActionsBuilder.prototype = {
      ...
      select.change(function() {
        ...
        if(newField.params) {
          for (var key in newField.params) {
            fieldsDiv.append(_this.buildField(key, newField.params[key]));
          }
        }
    ...
    buildField: function(fieldName, fieldType) {
      ...
      if(fieldType == "select") {
        ...
        var input = $("<input>", {"type": "text", "name": fieldName, "class": "numeric"});
        div.append(input);
